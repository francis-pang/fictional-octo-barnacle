...
class HeapTest {
  ...
  void heapSort_null() {
    int[] nullArray = null;
    heap.heapSortAscending(nullArray);
  ...
  void heapSort_empty() {
    int[] emptyArray = {};
    heap.heapSortAscending(emptyArray);
  ...
  void heapSort_singleElement() {
    ...
    heap.heapSortAscending(singleElementArray);
  ...
  void heapSort_multipleElements() {
    ...
    heap.heapSortAscending(multipleElementsArray);
  ...
  void heapSort_alreadySorted() {
    ...
    heap.heapSortAscending(alreadySortedArray);
  ...
  void heapSort_reverseSorted() {
    ...
    heap.heapSortAscending(reverseSortedArray);
  ...
  void heapSort_boundaryLow() {
    ...
    heap.heapSortAscending(arrayWithLowBoundary);
