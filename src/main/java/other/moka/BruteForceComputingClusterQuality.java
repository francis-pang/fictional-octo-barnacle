...
public class BruteForceComputingClusterQuality {
    ...
    PriorityQueue<Integer> chosenSpeedPriorityQueue = new PriorityQueue<>();
      while (!speedReliablePriorityQueue.isEmpty()) {
        ...
        if (chosenSpeedPriorityQueue.size() < maxMachines) {
          speedUntilMaxMachine += speedReliable.speed;
          int newTotalSpeed = speedUntilMaxMachine;
  ...
  public static void main(String[] args) {
    BruteForceComputingClusterQuality computingClusterQuality = new BruteForceComputingClusterQuality();
...
//    List<Integer> reliabilities = Arrays.asList(31, 4, 100, 55, 50);
    ...
    System.out.println(computingClusterQuality.maximumClusterQuality(speeds, reliabilities, 3));
  }
}
